-- ============================================================================
-- FINAL FIX FOR MESSAGING RLS - CONFIRMED SCHEMA
-- messaging_messages: sender_profile_id ✅
-- messaging_channel_members: profile_id ✅
-- typing_indicators: profile_id (assumed from frontend code) ✅
-- ============================================================================
...
BEGIN
  ...
  -- Create INSERT policy with sender_profile_id (confirmed column)
...
BEGIN
  ...
  RAISE NOTICE '✅ Created typing_indicators RLS policies with profile_id';
END $$;
...
-- ============================================================================
SELECT '✅ Fix complete! All constraints and RLS policies created.' as status;
...
SELECT 
  'messaging_channel_members policies' as info,
  policyname,
  cmd as operation
FROM pg_policies
