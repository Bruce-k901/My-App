...
// OLD:
className =
  "w-full pl-10 pr-4 py-2 bg-white/[0.06] border border-white/[0.1] rounded-lg text-white placeholder-white/40";

// NEW:
className =
  "w-full pl-10 pr-4 py-2 bg-theme-button dark:bg-white/[0.06] border border-theme dark:border-white/[0.1] rounded-lg text-theme-primary dark:text-white placeholder:text-theme-tertiary dark:placeholder-white/40";
```
...
// NEW:
className =
  "p-1.5 rounded hover:bg-black/[0.05] dark:hover:bg-white/10 text-[rgb(var(--text-tertiary))] dark:text-white/60 hover:text-[rgb(var(--text-primary))] dark:hover:text-white";
```
