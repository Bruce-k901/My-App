-- Create contractors view to map to maintenance_contractors table
-- This allows existing code that queries 'contractors' to work with the actual 'maintenance_contractors' table
