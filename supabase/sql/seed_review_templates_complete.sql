-- ============================================================================
-- Complete Review Templates Seed Script
-- Run this in Supabase SQL Editor to add disciplinary template types and seed all templates
-- ============================================================================

-- Part 1: Add new enum values for disciplinary templates
DO $$ 
BEGIN
