...
CREATE TABLE IF NOT EXISTS sop_entries (
  ...
  category TEXT NOT NULL CHECK (category IN ('Prep', 'Cooking', 'Cleaning')),
...
-- RLS Policy: Users can delete SOPs from their own company (optional, might want to restrict this)
