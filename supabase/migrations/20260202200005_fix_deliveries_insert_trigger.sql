-- ============================================================================
-- Migration: Fix deliveries INSERT trigger to handle all columns
-- Description: Update trigger to accept all columns used by the API
-- ============================================================================

-- First, ensure all required columns exist in the stockly.deliveries table
DO $$
BEGIN
  -- ai_processed column
  IF NOT EXISTS (
