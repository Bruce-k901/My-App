...
BEGIN
  ...
  IF NOT EXISTS (
    ...
    -- Note: archived_at is already included from LIKE ... INCLUDING ALL
    -- But we'll ensure it has a default
    ALTER TABLE site_checklists_archive
...
-- ============================================================================
-- 6. Update RLS policies to prevent bulk deletions
-- ============================================================================
-- Add a policy that requires explicit WHERE clause (prevents DELETE FROM site_checklists)
-- Note: This is enforced at application level, but we document it here
