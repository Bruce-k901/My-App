-- ============================================================================
-- Migration: 20251112120000_fix_eho_compliance_summary_function.sql
-- Description: Fix get_compliance_summary to remove unnecessary access check
--              Since function is security definer and called from service role,
--              the access check is redundant and causes errors
-- ============================================================================

-- Fix get_compliance_summary function - remove has_site_access check
-- The function is security definer and called from service role, so RLS is bypassed
