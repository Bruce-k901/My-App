-- ============================================================================
-- Fix: check_recipe_data_integrity function - correct column names
-- Date: 2026-01-30
-- Description: Uses correct column names (ingredient_id instead of stock_item_id)
-- ============================================================================
...
DO $$
BEGIN
    RAISE NOTICE 'Fixed check_recipe_data_integrity function (correct column names)';
END $$;
