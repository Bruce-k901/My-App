...
BEGIN
  ...
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'companies')
    ...
    IF NOT EXISTS (
      ...
      WHERE constraint_name = 'conversations_company_id_fkey' 
    ...
    IF NOT EXISTS (
      SELECT 1 FROM information_schema.table_constraints 
      WHERE constraint_name = 'conversations_site_id_fkey' 
      AND table_schema = 'public' 
      AND table_name = 'conversations'
    ) THEN
      ALTER TABLE public.conversations 
    ...
    IF NOT EXISTS (
      SELECT 1 FROM information_schema.table_constraints 
      WHERE constraint_name = 'message_reads_user_id_fkey' 
      AND table_schema = 'public' 
      AND table_name = 'message_reads'
    ) THEN
      ALTER TABLE public.message_reads 
    ...
    IF NOT EXISTS (
      SELECT 1 FROM information_schema.table_constraints 
      WHERE constraint_name = 'message_mentions_message_id_fkey' 
      AND table_schema = 'public' 
      AND table_name = 'message_mentions'
    ) THEN
    ...
    IF NOT EXISTS (
      SELECT 1 FROM information_schema.table_constraints 
      WHERE constraint_name = 'message_mentions_mentioned_user_id_fkey' 
      AND table_schema = 'public' 
      AND table_name = 'message_mentions'
    ) THEN
      ALTER TABLE public.message_mentions 
    ...
    IF NOT EXISTS (
      SELECT 1 FROM information_schema.table_constraints 
      WHERE constraint_name = 'typing_indicators_conversation_id_fkey' 
      AND table_schema = 'public' 
    ...
    IF NOT EXISTS (
      SELECT 1 FROM information_schema.table_constraints 
      WHERE constraint_name = 'typing_indicators_user_id_fkey' 
      AND table_schema = 'public' 
      AND table_name = 'typing_indicators'
    ) THEN
      ALTER TABLE public.typing_indicators 
  ...
  ELSE
    RAISE NOTICE '⚠️ companies, sites, or profiles tables do not exist yet - skipping messaging system creation';
  END IF;
END $$;
