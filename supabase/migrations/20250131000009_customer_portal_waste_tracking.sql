...
BEGIN
  ...
  IF NOT EXISTS (
    ...
    RAISE NOTICE 'companies or order_book_orders table does not exist - skipping customer_portal_waste_tracking migration';
    RETURN;
  END IF;
  
  RAISE NOTICE 'Required tables found - proceeding with customer_portal_waste_tracking migration';
END $$;
