...
-- 2. Indexes
CREATE INDEX idx_recipe_audit_recipe ON stockly.recipe_audit_log(recipe_id, changed_at DESC);
CREATE INDEX idx_recipe_audit_company ON stockly.recipe_audit_log(company_id);
CREATE INDEX idx_recipe_audit_event_type ON stockly.recipe_audit_log(event_type);
