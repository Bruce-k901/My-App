-- ============================================================================
-- Migration: Ensure product_variants has a name column
-- Description: Adds product_name column if missing and updates the RPC function
-- ============================================================================

-- First, add product_name column if it doesn't exist
DO $$
BEGIN
  IF NOT EXISTS (
    ...
    IF EXISTS (
      ...
      RAISE NOTICE 'Renamed name to product_name';
    ELSE
...
-- Now update the RPC function to always use product_name
...
BEGIN
  ...
  IF p_supplier_id IS NOT NULL THEN
    ...
    IF v_product_variant_id IS NULL THEN
      ...
      -- Insert using product_name column (now guaranteed to exist)
