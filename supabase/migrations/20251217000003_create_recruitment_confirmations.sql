-- =====================================================
-- Recruitment Confirmation System
-- =====================================================
-- Allows candidates to confirm/decline/reschedule via email links
...
-- Comments
COMMENT ON TABLE public.application_confirmation_responses IS 
'Stores candidate responses to interview/trial/offer invitations via email confirmation links';

COMMENT ON COLUMN public.application_confirmation_responses.response_type IS 
'What they are responding to: interview, trial, or offer';

COMMENT ON COLUMN public.application_confirmation_responses.action IS 
'What they want to do: confirm (accept), decline (reject), or reschedule (change)';

COMMENT ON COLUMN public.applications.confirmation_token IS 
'Unique token for email confirmation links (secure, anonymous access)';
