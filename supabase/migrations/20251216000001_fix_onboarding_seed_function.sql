-- ============================================================================
-- Migration: 20251216000001_fix_onboarding_seed_function.sql
-- Description: Clean slate - drop and recreate seed functions without storage.copy_object
-- ============================================================================

DO $do$
BEGIN
  -- Drop all versions of the seed functions to start fresh
  ...
  RAISE NOTICE '✅ Dropped old seed functions';
  ...
  -- Create helper function (no storage operations)
  ...
  RAISE NOTICE '✅ Created helper function _seed_pack_doc';

  -- Create main seed function with improved documents
  ...
  RAISE NOTICE '✅ Created main seed function seed_company_wfm_starter_kit';
  RAISE NOTICE '🎉 Onboarding seed functions recreated successfully - ready to use!';
END $do$;
