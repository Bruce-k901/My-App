-- ============================================================================
-- Migration: Add function to create stock_item and product_variant
-- Description: Creates an RPC function that can be called from the frontend
--              to create stock_items and product_variants in one transaction
-- ============================================================================

-- Function to create or find stock_item and product_variant
...
COMMENT ON FUNCTION public.create_stock_item_and_variant IS
'Creates or finds a stock_item and optionally a product_variant.
Used when creating purchase order lines from library items.
Parameters:
  - p_company_id: Company UUID
  - p_name: Item name
  - p_stock_unit: Unit of measure (default: ea)
  - p_supplier_id: Optional supplier UUID for creating product_variant
  - p_unit_price: Optional unit price for the variant
  - p_library_type: Optional library type (ingredients_library, etc.)
  - p_library_item_id: Optional library item UUID
Returns JSON with success status and IDs.';
