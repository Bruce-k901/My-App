...
-- Verify the view exists (will error if it doesn't)
DO $$
BEGIN
  IF NOT EXISTS (
    ...
    RAISE EXCEPTION 'attendance_logs view does not exist. Run migration 20250221000008 first.';
  END IF;
END $$;
...
-- ============================================================================
-- Step 3: Ensure the view is properly accessible
-- ============================================================================

-- Verify the view exists and has clock_in_date column
DO $$
BEGIN
  IF NOT EXISTS (
    ...
    RAISE EXCEPTION 'attendance_logs view is missing clock_in_date column. Run migration 20250221000008 first.';
  END IF;
END $$;
