-- ============================================================================
-- Migration: Fix stock update function - remove costing_method reference
-- Description: Removes reference to non-existent costing_method column
-- ============================================================================

-- Drop and recreate to fix the query
...
BEGIN
  ...
  -- Process each delivery line (removed costing_method reference)
  FOR v_line IN
    SELECT dl.*,
...
'Updates stock_levels and creates stock_movements when a delivery is confirmed.';
