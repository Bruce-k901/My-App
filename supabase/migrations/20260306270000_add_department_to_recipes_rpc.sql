-- Add department column to get_recipes_with_profiles RPC function
...
'Loads all recipes for a company with creator/updater profile names, department, and related data';
