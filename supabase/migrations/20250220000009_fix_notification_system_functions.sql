-- ============================================================================
-- Migration: Fix notification system functions to use staff_attendance
-- Description: Updates functions from 20250216000009_create_notification_system.sql
--              to use the new staff_attendance table instead of attendance_logs
-- ============================================================================

BEGIN;

-- Update is_user_clocked_in function to use staff_attendance
-- This function is called by create_task_ready_notification
...
-- Update get_active_staff_on_site function to use staff_attendance
...
-- Update get_managers_on_shift function to use staff_attendance
