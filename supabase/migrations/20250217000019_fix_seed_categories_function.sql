-- ============================================================================
-- Migration: Fix Seed Stock Categories Function
-- Description: Add SECURITY DEFINER and proper error handling to seed function
-- ============================================================================

BEGIN;

-- Drop and recreate the function with SECURITY DEFINER
DROP FUNCTION IF EXISTS seed_stock_categories_for_company(UUID);
