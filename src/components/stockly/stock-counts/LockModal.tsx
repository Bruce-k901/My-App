      ...
      <DialogContent className="bg-white dark:bg-[#0B0D13] border-theme text-theme-primary max-w-md">
        ...
        <div className="space-y-4 mt-4">
          <div className="bg-blue-50 dark:bg-blue-600/10 border border-blue-200 dark:border-blue-600/30 rounded-lg p-4">
            <h4 className="font-medium text-theme-primary mb-2">What happens when locked:</h4>
          ...
          <div className="bg-gray-50 dark:bg-white/[0.03] rounded-lg p-4 space-y-2 text-sm">
            <div className="flex justify-between">
              ...
              <span className="text-theme-primary font-medium">{count.name}</span>
            </div>
            <div className="flex justify-between">
            ...
            <div className="flex justify-between">
              <span className="text-theme-secondary">Items counted:</span>
              <span className="text-theme-primary font-medium">{count.items_counted}</span>
            </div>
            <div className="flex justify-between">
              <span className="text-theme-secondary">Finalized:</span>
              <span className="text-theme-primary font-medium">
                {count.finalized_at 
