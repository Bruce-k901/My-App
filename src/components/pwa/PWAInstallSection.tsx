      ...
      <div className="p-4 rounded border border-green-500/30 bg-green-500/10">
        <div className="flex items-center gap-3">
          ...
          <div className="flex-1">
            <p className="font-medium text-theme-primary">App Installed</p>
            <p className="text-sm text-theme-tertiary">Opsly is installed on your device.</p>
          </div>
        </div>
      </div>
    );
              ...
              {showInstructions && (
                <div className="mt-3 p-3 rounded bg-slate-900/50 border border-slate-700">
                  {browser.isIOS ? (
                    ...
                    <div className="space-y-2 text-sm text-theme-secondary">
                      <p className="font-semibold text-theme-primary mb-2">Android Installation Steps:</p>
                      <div className="flex items-start gap-2">
                        <span className="font-semibold text-blue-400">1.</span>
                    ...
                    <div className="space-y-2 text-sm text-theme-secondary">
                      <p className="font-semibold text-theme-primary mb-2">Desktop Installation Steps:</p>
                      <div className="flex items-start gap-2">
                        <span className="font-semibold text-blue-400">1.</span>
