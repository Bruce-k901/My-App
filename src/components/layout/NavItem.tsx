  ...
  if (disabled) {
    return (
      <div className="flex items-center gap-3 px-3 py-2.5 rounded-lg opacity-40 cursor-not-allowed pointer-events-none">
        <div className="w-5 h-5 flex items-center justify-center text-theme-tertiary">
          {icon}
        </div>
    ...
    >
      ...
      <div
        className={cn(
          ...
          active ? "text-theme-primary" : "text-theme-tertiary group-hover:text-theme-secondary"
        )}
