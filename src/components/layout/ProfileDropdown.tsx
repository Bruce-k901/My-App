  ...
  return (
    <>
      <button
        ...
        `}
      >
        <div className="w-8 h-8 rounded-full bg-[#8A2B2B] flex items-center justify-center text-white font-medium text-sm">
          {initials}
        </div>
        ...
        >
          ...
          <div className="px-4 py-3 border-b border-[rgb(var(--border))] dark:border-white/[0.06]">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-full bg-[#8A2B2B] flex items-center justify-center text-white font-medium">
                {initials}
              </div>
