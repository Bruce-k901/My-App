...
export default function EmergencyBreakdowns() {
  ...
  if (!data.length)
    return (
      <div className="bg-[#101214]/80 border border-white/[0.06] rounded-2xl p-5 shadow-[0_0_12px_rgba(138, 43, 43,0.05)] text-theme-secondary flex items-center justify-center">
        <p>No pending maintenance tasks. All systems operational.</p>
      </div>
    );

  return (
    <div className="rounded-2xl bg-red-950/30 border border-red-500/40 p-5 shadow-[0_0_12px_rgba(138, 43, 43,0.05)]">
