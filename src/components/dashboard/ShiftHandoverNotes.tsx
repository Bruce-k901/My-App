...
export default function ShiftHandoverNotes() {
  ...
  return (
    <section className="bg-[#101214]/80 border border-white/[0.06] rounded-2xl p-5 shadow-[0_0_12px_rgba(138, 43, 43,0.05)] fade-in-soft">
      ...
      <textarea
        ...
        className="w-full h-24 bg-black/30 border border-white/10 rounded-xl p-3 text-sm text-theme-primary focus:outline-none focus:ring-2 focus:ring-[#8A2B2B]/40 textarea-hover-glow"
      />
