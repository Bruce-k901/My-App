    ...
    <div className="space-y-4">
      ...
      <div>
        ...
        >
          ...
          <option value="urgent" className="bg-[#0B0D13] text-white">Urgent</option>
        </select>
      </div>
      ...
      <div>
        ...
        >
          <option value="todo" className="bg-[#0B0D13] text-white">To Do</option>
          <option value="in_progress" className="bg-[#0B0D13] text-white">In Progress</option>
          <option value="blocked" className="bg-[#0B0D13] text-white">Blocked</option>
        </select>
      </div>
    </div>
  );
