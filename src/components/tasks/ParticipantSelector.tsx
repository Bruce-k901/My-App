    ...
    <div className="space-y-2">
              ...
              <div
                ...
                className={`flex items-center gap-2 px-3 py-1.5 rounded-lg ${
                  isCurrentUser
                    ...
                    : 'bg-[#EC4899]/20 border border-[#EC4899]/30'
                }`}
              >
                {user.avatar_url ? (
                  <img
      ...
      <div className="relative">
        <button
          ...
          className="w-full px-4 py-2 bg-white/[0.05] border border-white/[0.1] rounded-lg text-left text-sm text-white/60 hover:bg-white/[0.08] transition-colors flex items-center justify-between"
        >
        ...
        {isOpen && (
          <>
            ...
            />
            <div className="absolute z-20 w-full mt-1 bg-[#141823] border border-white/[0.1] rounded-lg shadow-xl max-h-60 overflow-hidden">
              {/* Search */}
              <div className="p-2 border-b border-white/[0.1]">
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-8 pr-3 py-1.5 bg-white/[0.05] border border-white/[0.1] rounded text-sm text-white placeholder-white/40 focus:outline-none focus:ring-2 focus:ring-[#EC4899]/50"
                  ...
                  availableUsers.map((user) => {
                    ...
                    return (
                      <button
                        ...
                        disabled={!canSelect}
                        className={`w-full px-4 py-2 text-left hover:bg-white/[0.05] transition-colors flex items-center gap-3 ${
