...
const TemperatureSparkline: React.FC<TemperatureSparklineProps> = ({
  ...
  return (
    <div className="relative group" style={{ width, height }}>
      ...
      {/* Tooltip on hover */}
      <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 px-2 py-1 bg-gray-100 dark:bg-slate-800 text-theme-primary text-xs rounded opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap pointer-events-none z-10">
