    ...
    <div className="space-y-8">
      ...
      <div>
        ...
        <div className="flex items-center justify-between p-4 rounded-xl bg-gray-50 dark:bg-white/[0.03] border border-theme">
          <div>
            <p className="font-medium text-theme-primary">Reduce Animations</p>
            <p className="text-sm text-theme-tertiary/50">Disable transitions and motion effects</p>
          </div>
          <ToggleSwitch
      ...
      <div>
        ...
        <div className="grid grid-cols-2 gap-3">
          ...
          >
            <span className={`text-sm font-medium ${(preferences.high_contrast ?? 'normal') === 'normal' ? 'text-[#D37E91]' : 'text-theme-secondary'}`}>
              Normal
            </span>
            <span className="text-xs text-theme-tertiary/40">Standard contrast</span>
          </button>
          <button
          ...
          >
            <span className={`text-sm font-medium ${preferences.high_contrast === 'high' ? 'text-[#D37E91]' : 'text-theme-secondary'}`}>
              High
            </span>
            <span className="text-xs text-theme-tertiary/40">Enhanced readability</span>
          </button>
        </div>
      </div>
    </div>
