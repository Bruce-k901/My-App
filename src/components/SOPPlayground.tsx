          ...
          <div className="flex flex-wrap gap-1">
            ...
            <div className="flex gap-1 border-l border-neutral-600 pl-2 ml-2">
              <button
                ...
                className="px-3 py-1.5 rounded-lg text-xs font-medium text-theme-primary bg-white/[0.06] border border-white/[0.1] hover:bg-white/[0.12] hover:border-magenta-400 hover:shadow-[0_0_12px_rgba(138, 43, 43,0.4)] transition-all duration-150 backdrop-blur-md"
              >
