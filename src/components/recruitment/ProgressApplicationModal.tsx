              ...
              if (!siteId) {
                ...
                if (rotaId) {
                  ...
                  const shiftData = {
                    ...
                    status: 'scheduled',
                    color: '#8A2B2B', // Pink for trial shifts
                ...
                <>
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      rows={4}
                      className="w-full px-3 py-2 bg-theme-surface border border-theme rounded-lg text-theme-primary placeholder:text-theme-tertiary dark:placeholder:text-theme-disabled focus:outline-none focus:border-[#8A2B2B] focus:ring-2 focus:ring-[#8A2B2B]/20 resize-none"
                    />
                  </div>
                      ...
                      <div className="space-y-4">
                        ...
                        <div>
                          ...
                          <select
                            ...
                            className="w-full px-3 py-2 bg-gray-100 dark:bg-[#1a1d24] border border-gray-200 dark:border-white/10 rounded-lg text-theme-primary focus:outline-none focus:border-[#8A2B2B] [&>option]:bg-white dark:[&>option]:bg-[#1a1d24] [&>option]:text-theme-primary"
                          >
                        ...
                        <div>
                          ...
                          {loadingSiteStaff ? (
                            ...
                            <select
                              ...
                              className="w-full px-3 py-2 bg-gray-100 dark:bg-[#1a1d24] border border-gray-200 dark:border-white/10 rounded-lg text-theme-primary focus:outline-none focus:border-[#8A2B2B] disabled:opacity-50 disabled:cursor-not-allowed [&>option]:bg-white dark:[&>option]:bg-[#1a1d24] [&>option]:text-theme-primary"
                            >
                        ...
                        <div className="pt-4 border-t border-gray-200 dark:border-white/[0.06]">
                          <label className="flex items-center gap-3 cursor-pointer">
                            <input
                              ...
                              className="w-4 h-4 rounded border-gray-300 dark:border-white/20 bg-gray-100 dark:bg-white/5 text-[#8A2B2B] focus:ring-[#8A2B2B]"
                            />
                            <div>
                              <div className="text-theme-primary text-sm font-medium">
