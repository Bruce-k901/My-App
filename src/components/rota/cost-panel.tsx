      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4 mb-4">
          ...
          <div className={`rounded-lg p-3 ${
            ...
            <p className="text-xs text-theme-tertiary">Target: {targetLabourPct}%</p>
          </div>
          ...
          <div className="bg-neutral-800 rounded-lg p-3">
            ...
            <p className="text-xl font-bold text-theme-primary">{rota.total_hours}h</p>
            <p className="text-xs text-theme-tertiary">
          ...
          <div className="bg-neutral-800 rounded-lg p-3">
            ...
            <p className="text-xs text-theme-tertiary">Based on history</p>
          </div>
          ...
          <div className={`rounded-lg p-3 ${
            ...
            <p className={`text-xl font-bold ${
              overtimeHours > 0 ? 'text-amber-400' : 'text-theme-tertiary'
            }`}>
              {overtimeHours.toFixed(1)}h
            </p>
            <p className="text-xs text-theme-tertiary">Above contracted</p>
          </div>
        </div>
        ...
        {staffHours.length > 0 && (
          <div className="bg-neutral-800 rounded-lg p-3">
            <h4 className="text-sm font-medium text-theme-primary mb-3">Staff Hours Breakdown</h4>
                ...
                .map((staff) => (
                  <div key={staff.profile_id} className="flex items-center gap-2">
                    <div className="flex-1 min-w-0">
                      <p className="text-sm text-theme-primary truncate">{staff.full_name}</p>
