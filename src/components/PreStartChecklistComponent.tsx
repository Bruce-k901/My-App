...
export default function PreStartChecklistComponent({ node, updateAttributes, selected, getPos, editor }) {
    ...
    <NodeViewWrapper className="my-4">
      <SOPBlockWrapper node={node} deleteNode={handleDelete}>
        ...
        <div className="flex items-center gap-2 text-xs text-gray-400">
          ...
          <span className="text-magenta-400 font-medium">🧼 Pre-Start Checks</span>
        </div>
        <button
          onClick={addItem}
