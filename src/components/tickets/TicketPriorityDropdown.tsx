  ...
  return (
    <div className="relative">
      <select
        ...
        disabled={disabled}
        className="w-full appearance-none px-3 py-2 pr-8 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-[#8A2B2B] disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer"
        style={{ color: '#111113', backgroundColor: '#ffffff', border: '1px solid #9CA3AF' }}
      >
        {PRIORITY_OPTIONS.map((priority) => (
          <option key={priority} value={priority} style={{ color: '#111113', backgroundColor: '#ffffff' }}>
