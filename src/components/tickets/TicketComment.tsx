          ...
          <div className="mt-3 flex flex-wrap gap-2">
            {comment.attachments.map((attachment) => (
              <a
                ...
                className="inline-flex items-center gap-2 px-3 py-1.5 rounded-lg bg-gray-100 dark:bg-white/[0.06] border border-gray-300 dark:border-white/[0.06] text-sm text-gray-600 dark:text-gray-300 hover:bg-gray-200 dark:hover:bg-white/[0.09] transition-colors"
              >
