...
export default function UnifiedEntityCard({
  ...
  return (
    <motion.div
      ...
      className={`cursor-pointer rounded-xl bg-white/[0.05] border border-white/[0.1] backdrop-blur-md px-6 py-4 min-h-[72px] shadow-[0_0_20px_rgba(0,0,0,0.4)] hover:shadow-[0_0_12px_rgba(138, 43, 43,0.25)] hover:border-[#8A2B2B]/40 transition-colors relative ${className}`}
