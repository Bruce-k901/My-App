    ...
    >
      ...
      <AnimatePresence>
        {visible && (
          ...
          >
            <div className="bg-[#14161c]/95 backdrop-blur-sm text-white/90 text-xs px-2.5 py-1 rounded-md border border-white/[0.08] shadow-[0_0_14px_rgba(138, 43, 43,0.25)] whitespace-nowrap pointer-events-none">
              {label}
            </div>
          </motion.div>
        )}
