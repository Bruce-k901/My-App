...
export default function UploadGlobalDocModal({
  ...
  return (
    <div className="p-6 bg-white dark:bg-[#0b0f1a] rounded-2xl shadow-lg w-[500px] border border-theme">
      <h2 className="text-xl font-semibold text-theme-primary mb-4">Upload Document</h2>
      ...
      <div className="space-y-3">
        ...
        <div>
          <label className="block text-sm text-theme-secondary mb-1">Expiry Date (optional)</label>
          <Input
            type="date"
        ...
        <div>
          <label className="block text-sm text-theme-secondary mb-1">Notes (optional)</label>
          <textarea
        ...
        <div className="mt-3">
          <label className="text-sm text-theme-secondary mb-1 block">Select File</label>
          <input
            type="file"
