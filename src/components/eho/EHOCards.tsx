    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
      <EHOSection title="Policies" icon={FileText}>
        <div className="flex items-center gap-3">
          ...
          <span className="text-slate-400 text-sm ml-auto">Total: {policies.total}</span>
        </div>
      </EHOSection>
      ...
      <EHOSection title="Risk Assessments" icon={ClipboardCheck}>
        <div className="flex items-center gap-3">
          ...
          <span className="text-slate-400 text-sm ml-auto">Total: {risks.total}</span>
        </div>
      </EHOSection>
      ...
      <EHOSection title="COSHH Register" icon={AlertTriangle}>
        <div className="flex items-center gap-3">
          ...
          <span className="text-slate-400 text-sm ml-auto">Total: {coshh.total}</span>
        </div>
      </EHOSection>
    </div>
  );
