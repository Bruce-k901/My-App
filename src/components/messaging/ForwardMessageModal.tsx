        ...
        <div className="p-4 border-b border-gray-200 dark:border-white/[0.06]">
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2 bg-gray-50 dark:bg-white/[0.05] border border-gray-300 dark:border-white/[0.06] rounded-lg text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-white/40 focus:outline-none focus:ring-2 focus:ring-[#D37E91]/50"
            />
          </div>
        </div>
