...
import { CheckSquare, X, Calendar } from '@/components/ui/icons';
...
export default function ConvertToTaskModal({ 
  ...
  return (
    <div className="fixed inset-0 bg-black/40 dark:bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4">
      <div className="bg-white dark:bg-[#1a1d2e] border border-gray-200 dark:border-white/[0.08] rounded-xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
        {/* Header */}
        <div className="flex items-center justify-between p-6 border-b border-gray-200 dark:border-white/[0.06]">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-xl font-semibold text-gray-900 dark:text-white">Convert to Task</h2>
              <p className="text-sm text-gray-600 dark:text-white/60">Create a trackable task from this message</p>
            </div>
          </div>
          <button
            onClick={onClose}
        ...
        <div className="p-6 space-y-4">
          ...
          <div className="bg-gray-50 dark:bg-white/[0.03] border border-gray-200 dark:border-white/[0.06] rounded-lg p-4">
            <p className="text-xs text-gray-500 dark:text-white/40 mb-2">Original Message:</p>
            <p className="text-sm text-gray-700 dark:text-white/80 line-clamp-3">{message.content}</p>
          </div>
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-3 bg-white dark:bg-white/[0.03] border border-gray-300 dark:border-white/[0.06] rounded-lg text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-white/40 focus:outline-none focus:border-[#D37E91] transition-colors"
          ...
          <div>
            ...
            <textarea
              ...
              rows={4}
              className="w-full px-4 py-3 bg-white dark:bg-white/[0.03] border border-gray-300 dark:border-white/[0.06] rounded-lg text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-white/40 focus:outline-none focus:border-[#D37E91] transition-colors resize-none"
          ...
          <div>
            ...
            <select
              ...
              className="w-full px-4 py-3 bg-white dark:bg-white/[0.03] border border-gray-300 dark:border-white/[0.06] rounded-lg text-gray-900 dark:text-white focus:outline-none focus:border-[#D37E91] transition-colors appearance-none cursor-pointer"
              style={{
            ...
            {sites.length === 0 && (
              <p className="text-xs text-gray-500 dark:text-white/50 mt-1">No sites available. Please create a site first.</p>
            )}
          </div>
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-3 bg-white dark:bg-white/[0.03] border border-gray-300 dark:border-white/[0.06] rounded-lg text-gray-900 dark:text-white focus:outline-none focus:border-[#D37E91] transition-colors"
            />
          </div>
        </div>
        ...
        <div className="flex items-center justify-end gap-3 p-6 border-t border-gray-200 dark:border-white/[0.06]">
          <button
            onClick={onClose}
            className="px-6 py-2.5 bg-gray-100 dark:bg-white/[0.03] border border-gray-300 dark:border-white/[0.06] rounded-lg text-gray-700 dark:text-white hover:bg-gray-200 dark:hover:bg-white/[0.06] transition-colors"
            disabled={loading}
          >
            Cancel
          </button>
