    ...
    <div className="flex flex-col h-full">
      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-4">
        {messages.map((message: Message & { channel?: { id: string; name: string | null } }) => (
          <div
            key={message.id}
            className="bg-gray-50 dark:bg-white/[0.03] rounded-lg p-3 border border-theme hover:border-gray-300 dark:hover:border-white/[0.1] transition cursor-pointer"
          ...
          >
            ...
            {/* Message content */}
            <div className="text-sm text-theme-secondary line-clamp-2 mb-2">
              {message.content}
            </div>
