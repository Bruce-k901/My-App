        ...
        <div className="p-6 space-y-4">
          ...
          <div>
            ...
            <select
              ...
              className="w-full px-4 py-3 bg-white/[0.03] border border-white/[0.06] rounded-lg text-theme-primary focus:outline-none focus:border-[#8A2B2B] transition-colors"
              required
            >
                ...
                <button
                  ...
                  className={`
                    ...
                    ${calloutData.callout_type === type
                      ? 'bg-transparent border-[#8A2B2B] text-[#8A2B2B]'
          ...
          <div>
            ...
            <textarea
              ...
              rows={4}
              className="w-full px-4 py-3 bg-white/[0.03] border border-white/[0.06] rounded-lg text-theme-primary placeholder-white/40 focus:outline-none focus:border-[#8A2B2B] transition-colors resize-none"
