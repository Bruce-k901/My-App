  ...
  return (
    <div className="max-w-4xl mx-auto py-6 px-4">
      <div className="flex items-center justify-between mb-4">
        ...
        <Link href="/incidents/new" className="bg-transparent border border-[#8A2B2B] text-[#8A2B2B] px-3 py-2 rounded hover:shadow-[0_0_12px_rgba(138, 43, 43,0.7)] transition-all duration-200">Add New Report</Link>
      </div>
              ...
              <div className="mt-3 flex items-center gap-3">
                ...
                {it.status !== "resolved" && (
                  <>
                    ...
                    />
                    <button className="bg-transparent border border-[#8A2B2B] text-[#8A2B2B] px-3 py-1 rounded hover:shadow-[0_0_12px_rgba(138, 43, 43,0.7)] transition-all duration-200" onClick={() => resolveIncident(it.id)}>Mark Resolved</button>
                  </>
                )}
              </div>
            </li>
