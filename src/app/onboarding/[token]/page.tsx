      ...
      <div className="bg-gradient-to-b from-[#8A2B2B]/10 to-transparent border-b border-white/[0.06]">
        <div className="max-w-4xl mx-auto px-6 py-8">
          <div className="flex items-center gap-3 mb-6">
            <div className="w-12 h-12 rounded-full bg-[#8A2B2B]/10 border-2 border-[#8A2B2B]/30 flex items-center justify-center">
              <CheckCircle2 className="w-6 h-6 text-[#8A2B2B]" />
            </div>
            <div>
                ...
                return (
                  <div key={step} className="flex-1 flex items-center gap-2">
                    <div className={`flex-1 h-2 rounded-full ${
                      isActive ? 'bg-[#8A2B2B]' : 'bg-white/10'
                    }`} />
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white/[0.03] border border-white/[0.06] rounded-xl p-6 space-y-5">
              <h3 className="text-theme-primary font-semibold flex items-center gap-2">
                <User className="w-5 h-5 text-[#8A2B2B]" />
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 bg-white/5 border border-white/10 rounded-lg text-theme-primary placeholder:text-theme-disabled focus:outline-none focus:border-[#8A2B2B]"
                  />
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 bg-white/5 border border-white/10 rounded-lg text-theme-primary focus:outline-none focus:border-[#8A2B2B]"
                  />
                </div>
                ...
                <div>
                  ...
                  <select
                    ...
                    className="w-full px-4 py-3 bg-white/5 border border-white/10 rounded-lg text-white focus:outline-none focus:border-[#8A2B2B] [&>option]:bg-[#1a1d24] [&>option]:text-white"
                  >
            ...
            <div className="bg-white/[0.03] border border-white/[0.06] rounded-xl p-6 space-y-4">
              <h3 className="text-theme-primary font-semibold flex items-center gap-2">
                <MapPin className="w-5 h-5 text-[#8A2B2B]" />
                Home Address
              </h3>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 bg-white/5 border border-white/10 rounded-lg text-theme-primary placeholder:text-theme-disabled focus:outline-none focus:border-[#8A2B2B] uppercase"
                  />
                </div>
              </div>
            </div>
            ...
            <div className="bg-white/[0.03] border border-white/[0.06] rounded-xl p-6 space-y-4">
              <h3 className="text-theme-primary font-semibold flex items-center gap-2">
                <FileText className="w-5 h-5 text-[#8A2B2B]" />
                    ...
                    {rightToWorkDocumentType && (
                      <div>
                        ...
                        <input
                          ...
                          className="w-full px-4 py-3 bg-white/5 border border-white/10 rounded-lg text-theme-primary placeholder-white/30 focus:outline-none focus:border-[#8A2B2B]"
                        />
                        {rightToWorkDocumentType === 'share_code' && (
                          <p className="text-xs text-theme-tertiary mt-1">
                            Get your share code from <a href="https://www.gov.uk/view-prove-immigration-status" target="_blank" rel="noopener noreferrer" className="text-[#8A2B2B] underline">gov.uk/view-prove-immigration-status</a>
                          </p>
                        )}
                      </div>
                    )}
            ...
            <div className="bg-white/[0.03] border border-white/[0.06] rounded-xl p-6 space-y-4">
              <h3 className="text-theme-primary font-semibold flex items-center gap-2">
                <DollarSign className="w-5 h-5 text-[#8A2B2B]" />
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    maxLength={8}
                    className="w-full px-4 py-3 bg-white/5 border border-white/10 rounded-lg text-theme-primary placeholder:text-theme-disabled focus:outline-none focus:border-[#8A2B2B] font-mono"
                  />
                </div>
            ...
            <div className="bg-white/[0.03] border border-white/[0.06] rounded-xl p-6 space-y-4">
              <h3 className="text-theme-primary font-semibold flex items-center gap-2">
                <Phone className="w-5 h-5 text-[#8A2B2B]" />
                Emergency Contact
              </h3>
          ...
          <div className="space-y-6">
                  ...
                  >
                    <div className="flex items-start justify-between gap-4">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <button
                          className="px-4 py-1.5 rounded-lg text-sm bg-transparent text-[#8A2B2B] border border-[#8A2B2B] hover:shadow-[0_0_12px_rgba(138, 43, 43,0.7)] transition-all"
                        >
                          ✓ Acknowledge
                        </button>
                      </div>
            ...
            <div className="flex items-center justify-between">
              ...
              <button
                ...
                className="px-8 py-3 rounded-lg bg-transparent text-[#8A2B2B] border-2 border-[#8A2B2B] hover:shadow-[0_0_20px_rgba(138, 43, 43,0.7)] transition-all font-semibold"
              >
                Continue
              </button>
            </div>
              ...
              <div className="bg-white/[0.03] border border-white/[0.06] rounded-xl p-6 max-w-2xl mx-auto text-left">
                ...
                <ul className="space-y-3 text-theme-secondary text-sm">
                  <li className="flex items-start gap-3">
                    <span className="text-[#8A2B2B] mt-1">•</span>
