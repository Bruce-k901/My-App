...
const setupSteps: SetupStep[] = [
  ...
  },
  {
    ...
    description: 'Configure temperature logging schedules and alert thresholds.',
    ...
    benefits: [
      ...
      'Prevents food waste and safety incidents'
    ],
    tips: [
      'Set realistic temperature ranges',
      'Schedule checks at appropriate intervals',
      'Configure escalation for repeated failures',
      'Link to asset records for context'
    ]
  }
];
