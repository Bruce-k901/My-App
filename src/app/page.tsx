...
export default function HomePage() {
  return (
    <MarketingSubPageLayout>
      {/* HERO */}
      <section className="min-h-[75vh] flex flex-col items-center justify-center text-center px-6 pt-8">
      ...
      {/* PROBLEM SECTION */}
      <section className="py-10 bg-[#0f121c] border-t border-neutral-800 text-center">
        ...
        <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 px-6">
          <div className="bg-[#141823] rounded-2xl p-5 border border-neutral-800 hover:border-magenta-500/40 transition">
