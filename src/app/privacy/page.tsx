  ...
  return (
    <MarketingSubPageLayout>
      <section className="max-w-3xl mx-auto text-left py-16 px-6 space-y-6">
        ...
        <p className="text-sm text-theme-tertiary">Last updated: October 2025</p>
        ...
        <div>
          ...
          <p className="text-theme-tertiary">We collect:</p>
          <ul className="list-disc pl-6 space-y-2 text-theme-tertiary">
            <li>
              <span className="font-medium text-theme-primary">Account data:</span> name, email address,
              business name, and password.
            </li>
            <li>
              <span className="font-medium text-theme-primary">Usage data:</span> activity within the app,
              device type, browser, and IP address.
            </li>
            <li>
              <span className="font-medium text-theme-primary">Support data:</span> messages or attachments
              you send to our support team.
            </li>
          </ul>
          <p className="text-theme-tertiary">We don’t knowingly collect data from anyone under 16.</p>
        </div>

        {/* 3. How We Use Information */}
        <div>
          <h2 className="text-xl font-semibold mb-2">3. How We Use Information</h2>
          <p className="text-theme-tertiary">We use your information to:</p>
          <ul className="list-disc pl-6 space-y-2 text-theme-tertiary">
          ...
          <p className="text-theme-tertiary">We do not sell or rent your data to anyone.</p>
        </div>

        {/* 4. Legal Basis */}
        <div>
          <h2 className="text-xl font-semibold mb-2">4. Legal Basis</h2>
          <p className="text-theme-tertiary">Processing is based on:</p>
          <ul className="list-disc pl-6 space-y-2 text-theme-tertiary">
        ...
        <div>
          ...
          <p className="text-theme-tertiary">Depending on where you live, you may have the right to:</p>
          <ul className="list-disc pl-6 space-y-2 text-theme-tertiary">
