    ...
    <div className="p-6 space-y-6">
      ...
      <div className="flex items-start justify-between gap-4">
        ...
        <Link
          ...
          className="px-4 py-2 rounded-lg text-sm bg-transparent text-blue-600 dark:text-blue-400 border border-blue-600 dark:border-blue-400 hover:shadow-[0_0_12px_rgba(37,99,235,0.4)] dark:hover:shadow-[0_0_12px_rgba(96,165,250,0.5)] transition-all flex items-center gap-2"
        >
      ...
      {loading ? (
        ...
        <div className="bg-white dark:bg-white/[0.03] border border-gray-200 dark:border-white/[0.06] rounded-xl p-12 text-center">
          <Briefcase className="w-12 h-12 text-gray-900 dark:text-white/30 mx-auto mb-4" />
          <div className="text-gray-900 dark:text-white font-semibold text-lg">No jobs yet</div>
          ...
          {filterStatus === 'all' && (
            <Link
              href="/dashboard/people/recruitment/jobs/new"
              className="inline-flex items-center gap-2 px-4 py-2 rounded-lg text-sm bg-transparent text-blue-600 dark:text-blue-400 border border-blue-600 dark:border-blue-400 hover:shadow-[0_0_12px_rgba(37,99,235,0.4)] dark:hover:shadow-[0_0_12px_rgba(96,165,250,0.5)] transition-all"
            >
              <Plus className="w-4 h-4" />
              Post Your First Job
            </Link>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {filteredJobs.map((job) => (
            <div
              key={job.id}
              className="bg-white dark:bg-white/[0.03] border border-gray-200 dark:border-white/[0.06] rounded-xl p-5 hover:bg-gray-100 dark:hover:bg-white/[0.05] transition-all"
            >
              {/* Header */}
              <div className="flex items-start justify-between gap-3 mb-3">
                <div className="flex-1 min-w-0">
                  ...
                  {job.department && (
                    <p className="text-gray-900 dark:text-white/50 text-xs mt-0.5">{job.department}</p>
                  )}
                </div>
              ...
              <div className="space-y-2 mb-4">
                ...
                {/* Applicants */}
                <div className="flex items-center gap-2 text-xs text-gray-900 dark:text-white/60 pt-2">
              ...
              {/* Actions */}
              <div className="flex items-center gap-2 pt-3 border-t border-gray-200 dark:border-white/[0.06]">
                <Link
                  href={`/dashboard/people/recruitment/${job.id}`}
                  className="flex-1 px-3 py-1.5 rounded text-xs bg-gray-100 dark:bg-white/10 hover:bg-gray-200 dark:hover:bg-white/15 border border-gray-300 dark:border-white/10 text-gray-900 dark:text-white text-center"
                >
                ...
                <Link
                  ...
                  className="px-3 py-1.5 rounded text-xs bg-gray-100 dark:bg-white/5 hover:bg-gray-200 dark:hover:bg-white/10 border border-gray-300 dark:border-white/10 text-gray-900 dark:text-white/80"
                >
