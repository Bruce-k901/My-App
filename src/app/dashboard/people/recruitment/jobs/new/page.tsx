    ...
    <div className="p-6 max-w-4xl mx-auto space-y-6">
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="flex-1">
          <h1 className="text-xl font-semibold text-white">Post New Job</h1>
      ...
      <div className="bg-white/[0.03] border border-white/[0.06] rounded-xl p-6 space-y-6">
        ...
        <div className="space-y-4">
          ...
          <div>
            <label className="text-xs text-white/50 block mb-1">Job Title *</label>
            <input
              type="text"
              value={title}
          ...
          <div>
            <label className="text-xs text-white/50 block mb-1">Job Description</label>
            <textarea
              value={description}
        ...
        <div className="space-y-4 pt-4 border-t border-white/[0.06]">
          <div>
            <h2 className="text-white font-semibold mb-1">Position Type</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {/* BOH/FOH */}
            <div>
              <label className="text-xs text-white/50 block mb-2">Work Area *</label>
                ...
                {(['FOH', 'BOH', 'BOTH'] as const).map((option) => (
                  <button
                    ...
                    className={`px-3 py-2 rounded-lg text-sm transition-all ${
                      bohFoh === option
                        ? 'bg-[#EC4899]/20 text-[#EC4899] border-2 border-[#EC4899]'
            ...
            {/* Hourly/Salaried */}
            <div>
              <label className="text-xs text-white/50 block mb-2">Pay Structure *</label>
        ...
        {/* Pay & Contract */}
        <div className="space-y-4 pt-4 border-t border-white/[0.06]">
          <h2 className="text-white font-semibold">Pay & Contract</h2>
        ...
        <div className="space-y-4 pt-4 border-t border-white/[0.06]">
          ...
          <div>
            <label className="text-xs text-white/50 block mb-1">Experience Required</label>
            <input
              type="text"
        ...
        <div className="flex items-center justify-between gap-4 pt-4 border-t border-white/[0.06]">
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="px-4 py-2 rounded-lg text-sm bg-white/10 hover:bg-white/15 border border-white/10 text-white disabled:opacity-50 flex items-center gap-2"
            >
              {saving ? (
                <>
