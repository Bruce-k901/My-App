...
export default function TeamCalendarPage() {
        ...
        <div className="flex items-center justify-between mb-6">
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="p-2 text-theme-secondary hover:text-theme-primary hover:bg-gray-100 dark:hover:bg-white/[0.05] rounded-lg transition-colors"
            >
              <ChevronLeft className="h-4 w-4" />
            </button>
            <button
              onClick={() => setCurrentDate(new Date())}
              className="px-3 py-1 text-sm text-theme-secondary hover:text-theme-primary hover:bg-gray-100 dark:hover:bg-white/[0.05] rounded-lg transition-colors"
            >
              Today
            </button>
            <button
 ...
 isCurrentMonthDay ?'bg-theme-surface-elevated ]':'bg-theme-surface'
                  ...
                  <div className="space-y-1">
                    {dayReviews.slice(0, 3).map((review) => (
                      <Link
                        ...
                        className="block text-xs p-1 rounded bg-blue-500/10 dark:bg-blue-500/20 text-blue-700 dark:text-blue-300 border border-blue-300 dark:border-blue-500/50 hover:bg-module-fg/10 dark:hover:bg-module-fg/10 transition-colors truncate"
                        title={review.title}
                      >
