    ...
    return (
      <div className="space-y-6">
        <div className="text-center py-12">
          <p className="text-theme-primary/60">Loading general settings...</p>
        </div>
      </div>
    );
  }
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <h1 className="text-2xl font-bold text-theme-primary mb-2 flex items-center gap-2">
            <Settings className="w-6 h-6 text-module-fg" />
            General Settings
          </h1>
        ...
        <div className="flex items-center gap-3">
          <Button
            ...
            variant="outline"
            className="border-blue-600 dark:border-blue-400 text-module-fg hover:bg-module-fg/10"
          >
      ...
      <div className="bg-theme-surface border border-theme rounded-xl p-6">
        <h2 className="text-xl font-semibold text-theme-primary mb-6 flex items-center gap-2">
          <Building2 className="w-5 h-5 text-module-fg" />
          Company Information
        </h2>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            <label className="block text-sm text-theme-tertiary mb-2">Company Name</label>
            <Input
          ...
          <div>
            <label className="block text-sm text-theme-tertiary mb-2">Logo URL</label>
            <Input
          ...
          <div>
            <label className="block text-sm text-theme-tertiary mb-2">Address</label>
            <Input
          ...
          <div>
            <label className="block text-sm text-theme-tertiary mb-2">City</label>
            <Input
          ...
          <div>
            <label className="block text-sm text-theme-tertiary mb-2">Postcode</label>
            <Input
          ...
          <div>
            <label className="block text-sm text-theme-tertiary mb-2">Country</label>
            <Input
          ...
          <div>
            <label className="block text-sm text-theme-tertiary mb-2">Phone</label>
            <Input
          ...
          <div>
            <label className="block text-sm text-theme-tertiary mb-2">Email</label>
            <Input
              type="email"
          ...
          <div className="md:col-span-2">
            <label className="block text-sm text-theme-tertiary mb-2">Website</label>
            <Input
      ...
      <div className="bg-theme-surface border border-theme rounded-xl p-6">
        <h2 className="text-xl font-semibold text-theme-primary mb-6 flex items-center gap-2">
          <Clock className="w-5 h-5 text-module-fg" />
          Time & Locale
        </h2>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            <label className="block text-sm text-theme-tertiary mb-2">Timezone</label>
            <Input
              value={formData.timezone || ''}
              onChange={(e) => updateField('timezone', e.target.value)}
              placeholder="Europe/London"
            />
            <p className="text-xs text-theme-tertiary mt-1">e.g., Europe/London, America/New_York</p>
          </div>
          <div>
            <label className="block text-sm text-theme-tertiary mb-2">Date Format</label>
            <Select
          ...
          <div>
            <label className="block text-sm text-theme-tertiary mb-2">Time Format</label>
            <Select
          ...
          <div>
            <label className="block text-sm text-theme-tertiary mb-2">Week Start Day</label>
            <Select
      ...
      <div className="bg-theme-surface border border-theme rounded-xl p-6">
        ...
        <div className="space-y-4">
          <div>
            <label className="block text-sm text-theme-tertiary mb-2">Standard Shift Length (hours)</label>
            <Input
              type="number"
              step="0.5"
              min="0"
          ...
          <div>
            <label className="block text-sm text-theme-tertiary mb-4">Default Business Hours</label>
              ...
              {days.map((day) => {
                ...
                return (
                  <div key={day} className="flex items-center gap-4 p-3 bg-gray-50 dark:bg-white/[0.02] rounded-lg flex-wrap">
                    <div className="w-24 text-sm text-theme-primary font-medium flex-shrink-0">{dayName}</div>
                    <label className="flex items-center gap-2 text-sm text-theme-tertiary flex-shrink-0">
                      <input
                        type="checkbox"
                    ...
                    {!dayHours.closed && (
                      <div className="flex items-center gap-3 flex-1 min-w-0">
                        ...
                        <span className="text-theme-tertiary flex-shrink-0 px-1">to</span>
                        <div className="flex-shrink-0 min-w-0">
                          <TimePicker
      ...
      <div className="bg-theme-surface border border-theme rounded-xl p-6">
        <h2 className="text-xl font-semibold text-theme-primary mb-6 flex items-center gap-2">
          <DollarSign className="w-5 h-5 text-module-fg" />
          Pay Periods
        </h2>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            <label className="block text-sm text-theme-tertiary mb-2">Pay Period Type</label>
            <Select
          ...
          <div>
            <label className="block text-sm text-theme-tertiary mb-2">Pay Day</label>
            <Select
          ...
          {formData.pay_day === 'specific_day' && (
            <div>
              <label className="block text-sm text-theme-tertiary mb-2">Day of Month (1-31)</label>
              <Input
                type="number"
                min="1"
                max="31"
      ...
      <div className="bg-theme-surface border border-theme rounded-xl p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div>
            <label className="block text-sm text-theme-tertiary mb-2">Currency Code</label>
            <Select
          ...
          <div>
            <label className="block text-sm text-theme-tertiary mb-2">Currency Symbol</label>
            <Input
          ...
          <div>
            <label className="block text-sm text-theme-tertiary mb-2">Currency Format</label>
            <Select
      ...
      <div className="bg-theme-surface border border-theme rounded-xl p-6">
        ...
        <div>
          <label className="block text-sm text-theme-tertiary mb-2">Fiscal Year Start Month</label>
          <Select
      ...
      <div className="bg-theme-surface border border-theme rounded-xl p-6">
        ...
        <div className="mb-6 p-4 bg-gray-50 dark:bg-white/[0.02] border border-gray-200 dark:border-white/[0.04] rounded-lg">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-3">
            <div>
              <label className="block text-sm text-theme-tertiary mb-2">Start Date</label>
              <DatePicker
                ...
                className="w-full px-3 py-2 bg-theme-button border border-theme rounded text-sm text-theme-primary placeholder-neutral-500 focus:outline-none focus:border-blue-600 dark:focus:border-blue-400"
                dateFormat="dd/MM/yyyy"
              />
            </div>
            <div>
              <label className="block text-sm text-theme-tertiary mb-2">End Date</label>
              <DatePicker
            ...
            <div>
              <label className="block text-sm text-theme-tertiary mb-2">Notes (optional)</label>
              <Input
        ...
        {loadingClosures ? (
          <div className="text-center py-4">
            <p className="text-theme-primary/60">Loading closures...</p>
          </div>
            ...
            {closures.map((closure) => (
              ...
              >
                <div className="flex-1">
                  ...
                  {closure.notes && (
                    <div className="text-sm text-theme-tertiary mt-1">{closure.notes}</div>
                  )}
                </div>
                <Button
                  onClick={async () => {
