  ...
  return (
    <div className="p-8">
      <div className="mb-8">
        ...
        <p className="text-white/60">Pre-built compliance task templates</p>
      </div>
      ...
      <div className="bg-white/[0.03] border border-white/[0.06] rounded-xl p-8">
        <div className="text-center">
          ...
          <h2 className="text-xl font-semibold text-white mb-2">Compliance Templates</h2>
          <p className="text-white/60 max-w-md mx-auto">
            Ready-made compliance task templates for food safety, health & safety, and regulatory requirements.
          </p>
        </div>
      </div>
    </div>
