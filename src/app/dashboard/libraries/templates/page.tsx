...
export default function LibraryTemplatesPage() {
  return (
    <div className="p-8">
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-white mb-2">Library Templates</h1>
        <p className="text-white/60">Pre-built library item templates</p>
      </div>
      ...
      <div className="bg-white/[0.03] border border-white/[0.06] rounded-xl p-8">
        <div className="text-center">
          ...
          <h2 className="text-xl font-semibold text-white mb-2">Library Templates</h2>
