        ...
        <div className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="p-6 bg-white/[0.03] border border-white/[0.06] rounded-xl">
              <h3 className="text-lg font-medium text-theme-primary mb-3">Getting Started</h3>
            ...
            <div className="p-6 bg-white/[0.03] border border-white/[0.06] rounded-xl">
              <h3 className="text-lg font-medium text-theme-primary mb-3">Common Tasks</h3>
              <ul className="space-y-2 text-sm text-theme-tertiary">
        ...
        <div className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="p-6 bg-white/[0.03] border border-white/[0.06] rounded-xl text-center">
              <Mail className="w-8 h-8 text-module-fg mx-auto mb-3" />
            ...
            <div className="p-6 bg-white/[0.03] border border-white/[0.06] rounded-xl text-center">
              ...
              <h3 className="text-lg font-medium text-theme-primary mb-2">Schedule Call</h3>
              <p className="text-theme-tertiary text-sm mb-4">Book a time that works for you</p>
              <button className="inline-flex items-center gap-2 px-4 py-2 bg-green-500/20 border border-green-500/40 rounded-lg text-green-300 hover:bg-module-fg/10 transition-colors">
          ...
          <div className="p-6 bg-white/[0.03] border border-white/[0.06] rounded-xl">
            <h3 className="text-lg font-medium text-theme-primary mb-3">Support Hours</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm text-theme-tertiary">
              <div>
                <p className="font-medium text-theme-primary">Monday - Friday</p>
                <p>9:00 AM - 6:00 PM EST</p>
              </div>
              <div>
                <p className="font-medium text-theme-primary">Weekend Support</p>
    ...
    },
    {
      ...
      content: (
        <div className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="p-6 bg-white/[0.03] border border-white/[0.06] rounded-xl">
              <h3 className="text-lg font-medium text-theme-primary mb-3">User Guides</h3>
              <ul className="space-y-3">
                <li>
                  <a href="#" className="flex items-center gap-2 text-module-fg hover:text-module-fg/70 transition-colors">
            ...
            <div className="p-6 bg-white/[0.03] border border-white/[0.06] rounded-xl">
              <h3 className="text-lg font-medium text-theme-primary mb-3">API Documentation</h3>
              <ul className="space-y-3">
                <li>
          ...
          <div className="p-6 bg-gradient-to-r from-purple-500/10 to-module-fg/[0.10] border border-purple-500/20 rounded-xl">
            ...
            <button 
              ...
              className="px-4 py-2 bg-purple-500/20 border border-purple-500/40 rounded-lg text-purple-300 hover:bg-module-fg/10 transition-colors"
            >
              Contact Support
            </button>
          </div>
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-gradient-to-r from-magenta-600/20 to-blue-600/20 rounded-2xl p-6 border border-magenta-500/30">
        ...
        <p className="text-theme-tertiary text-sm">Get help, find documentation, and contact our support team</p>
      </div>
            ...
            <button
              ...
              className={`flex items-center gap-2 px-4 py-2 rounded-md transition-colors ${
                activeTab === section.id
                  ? 'bg-module-fg/[0.25] text-module-fg border border-module-fg/[0.40]'
                  : 'text-theme-tertiary hover:text-white hover:bg-white/[0.08]'
              }`}
            >
