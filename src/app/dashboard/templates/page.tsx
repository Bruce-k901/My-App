  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-gradient-to-r from-magenta-600/20 to-blue-600/20 rounded-2xl p-6 border border-magenta-500/30">
        ...
        <p className="text-theme-tertiary text-sm">Reusable task templates for consistent workflows</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {loading ? (
          <div className="col-span-full text-center py-12">
            ...
            <p className="text-theme-tertiary mt-2">Loading templates...</p>
          </div>
        ) : filteredTemplates.length === 0 ? (
          <div className="col-span-full text-center py-12">
            <div className="w-16 h-16 bg-theme-surface-elevated0/10 rounded-full flex items-center justify-center mx-auto mb-4">
              <Copy className="w-8 h-8 text-theme-tertiary" />
            </div>
            <h3 className="text-lg font-medium text-theme-primary mb-2">No templates found</h3>
            <p className="text-theme-tertiary">Create your first template to get started</p>
          </div>
        ) : (
            ...
            >
              <div className="flex items-start justify-between mb-4">
                <div className="flex-1">
                  <h3 className="text-lg font-medium text-theme-primary mb-2">{template.name}</h3>
                  <p className="text-theme-tertiary text-sm mb-3">{template.description}</p>
