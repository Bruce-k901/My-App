                    ...
                    <div className="flex-1">
                      <div className="flex items-center gap-2 mb-2">
                        ...
                        {incident.riddor_reported && (
                          <span className="px-2 py-1 rounded-md text-xs font-medium bg-green-50 dark:bg-green-500/20 text-green-700 dark:text-green-300 border border-green-200 dark:border-green-500/40">
                            RIDDOR REPORTED
                          </span>
                        )}
                      </div>
