    ...
    <div className="max-w-5xl mx-auto">
      ...
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-2xl font-bold text-white">Stockly Settings</h1>
            <p className="text-white/60 text-sm mt-1">Configure how Stockly works for your business</p>
          </div>
        </div>
        ...
        <div className="flex-1 bg-white/[0.03] border border-white/[0.06] rounded-xl p-6">
          ...
          {activeSection === 'costing' && (
            <div className="space-y-6">
              <div>
                <h2 className="text-lg font-semibold text-white mb-1">GP & Costing</h2>
                <p className="text-white/50 text-sm">Default targets for gross profit and pricing</p>
              </div>
              
              <div className="grid grid-cols-2 gap-6">
                <div>
                  <label className="block text-sm font-medium text-white/80 mb-2">Default GP Target</label>
                  <div className="relative">
                    <input
                      type="number"
                      value={settings.default_gp_target}
                      onChange={(e) => updateSetting('default_gp_target', parseFloat(e.target.value) || 70)}
                      className="w-full px-3 py-2 pr-8 bg-white/5 border border-white/10 rounded-lg text-white focus:outline-none focus:border-magenta-500"
                    />
                    <span className="absolute right-3 top-1/2 -translate-y-1/2 text-white/40">%</span>
                  </div>
                  <p className="text-white/40 text-xs mt-1">Used as default when creating new recipes</p>
                </div>
                
                <div>
                  <label className="block text-sm font-medium text-white/80 mb-2">Default VAT Rate</label>
                  <div className="relative">
                    <input
                      type="number"
                  ...
                  <p className="text-white/40 text-xs mt-1">Applied to deliveries and pricing calculations</p>
                </div>
              </div>
            </div>
          )}
          ...
          {activeSection === 'staff' && (
            <div className="space-y-6">
              <div>
                <h2 className="text-lg font-semibold text-white mb-1">Staff Purchases</h2>
                <p className="text-white/50 text-sm">Control staff discount and payment options</p>
              </div>
              
              <div>
                <label className="block text-sm font-medium text-white/80 mb-2">Default Staff Discount</label>
              ...
              <div>
                <label className="block text-sm font-medium text-white/80 mb-2">Allowed Payment Methods</label>
                <div className="flex flex-wrap gap-2">
              ...
              <div>
                <label className="block text-sm font-medium text-white/80 mb-2">Require Approval Above</label>
                <div className="flex items-center gap-3">
                  <div className="relative flex-1 max-w-xs">
                    ...
                    <input
                      ...
                      className="w-full pl-7 pr-3 py-2 bg-white/5 border border-white/10 rounded-lg text-white placeholder:text-white/30 focus:outline-none focus:border-magenta-500"
                    />
                  </div>
                  <span className="text-white/40 text-sm">Leave empty for no approval required</span>
                </div>
              </div>
            </div>
          )}
          ...
          {activeSection === 'alerts' && (
            <div className="space-y-6">
              <div>
                <h2 className="text-lg font-semibold text-white mb-1">Alerts</h2>
                <p className="text-white/50 text-sm">Configure when to show warnings</p>
              </div>
              ...
              <div className="space-y-4">
                <label className="flex items-center justify-between p-4 bg-white/[0.02] rounded-lg cursor-pointer">
                  <div>
                    ...
                    <p className="text-white/40 text-sm">Warn when items fall below threshold</p>
                  </div>
                  <input
                    type="checkbox"
                  ...
                  <div className="ml-4">
                    ...
                    <div className="relative max-w-xs">
                      <input
                        ...
                        className="w-full px-3 py-2 pr-20 bg-white/5 border border-white/10 rounded-lg text-white focus:outline-none focus:border-magenta-500"
                      />
                      <span className="absolute right-3 top-1/2 -translate-y-1/2 text-white/40">% of reorder point</span>
                    </div>
                  </div>
                )}
                ...
                <label className="flex items-center justify-between p-4 bg-white/[0.02] rounded-lg cursor-pointer">
                  <div>
                    <span className="text-white font-medium">Expiry Alerts</span>
                    <p className="text-white/40 text-sm">Warn before items expire</p>
                  </div>
                  <input
                    type="checkbox"
                ...
                {settings.enable_expiry_alerts && (
                  <div className="ml-4">
                    <label className="block text-sm font-medium text-white/80 mb-2">Days Before Expiry</label>
                    <div className="relative max-w-xs">
                      <input
                        type="number"
                        value={settings.expiry_warning_days}
                        onChange={(e) => updateSetting('expiry_warning_days', parseInt(e.target.value) || 3)}
                        className="w-full px-3 py-2 pr-12 bg-white/5 border border-white/10 rounded-lg text-white focus:outline-none focus:border-magenta-500"
                      />
                      <span className="absolute right-3 top-1/2 -translate-y-1/2 text-white/40">days</span>
                    </div>
                  </div>
                )}
              </div>
          ...
          {activeSection === 'counts' && (
            <div className="space-y-6">
              <div>
                <h2 className="text-lg font-semibold text-white mb-1">Stock Counts</h2>
                <p className="text-white/50 text-sm">Configure counting and variance thresholds</p>
              </div>
              
              <div className="grid grid-cols-2 gap-6">
                <div>
                  <label className="block text-sm font-medium text-white/80 mb-2">Variance Alert Threshold</label>
                  <div className="relative">
                    <input
                      type="number"
                      step="0.1"
                  ...
                  <p className="text-white/40 text-xs mt-1">Alert when variance exceeds this</p>
                </div>
                
                <div>
                  <label className="block text-sm font-medium text-white/80 mb-2">Auto-Approve Under</label>
                  <div className="relative">
                    <input
                      type="number"
                      step="0.1"
                  ...
                  <p className="text-white/40 text-xs mt-1">Auto-approve counts with tiny variances</p>
                </div>
              </div>
              
              <div>
                <label className="block text-sm font-medium text-white/80 mb-2">Count Reminder Frequency</label>
                <div className="flex flex-wrap gap-2">
          ...
          {activeSection === 'waste' && (
            <div className="space-y-6">
              <div>
                <h2 className="text-lg font-semibold text-white mb-1">Waste Recording</h2>
                <p className="text-white/50 text-sm">Configure wastage categories and requirements</p>
              </div>
              
              <div>
                <label className="block text-sm font-medium text-white/80 mb-2">Waste Reasons</label>
                <div className="flex flex-wrap gap-2 mb-3">
                  {settings.waste_reasons.map(reason => (
                    <span
                      key={reason}
                      className="px-3 py-1.5 bg-white/5 rounded-lg text-white/80 text-sm flex items-center gap-2"
                    >
                ...
                <div className="flex gap-2 max-w-sm">
                  <input
                    ...
                    className="flex-1 px-3 py-2 bg-white/5 border border-white/10 rounded-lg text-white placeholder:text-white/30 focus:outline-none focus:border-magenta-500"
              ...
              <label className="flex items-center justify-between p-4 bg-white/[0.02] rounded-lg cursor-pointer">
                <div>
                  <span className="text-white font-medium">Require Notes</span>
                  <p className="text-white/40 text-sm">Force staff to add notes when recording waste</p>
                </div>
                <input
                  type="checkbox"
          ...
          {activeSection === 'categories' && (
            <div className="space-y-6">
              <div>
                <h2 className="text-lg font-semibold text-white mb-1">Menu Categories</h2>
                <p className="text-white/50 text-sm">Categories used for recipes and reporting</p>
              </div>
          ...
          {activeSection === 'display' && (
            <div className="space-y-6">
              <div>
                <h2 className="text-lg font-semibold text-white mb-1">Display Preferences</h2>
                <p className="text-white/50 text-sm">How dates and data are shown</p>
              </div>
              ...
              <div className="grid grid-cols-2 gap-6">
                ...
                <div>
                  <label className="block text-sm font-medium text-white/80 mb-2">Week Starts On</label>
                  <select
              ...
              <div>
                <label className="block text-sm font-medium text-white/80 mb-2">Default Report Period</label>
                <div className="flex flex-wrap gap-2">
                  {[7, 14, 30, 90].map(days => (
                    <button
                      key={days}
