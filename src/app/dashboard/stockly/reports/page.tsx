  ...
  const quickReports = [
    {
      ...
      icon: Package,
      href: '/dashboard/stockly/reports/stock-value',
      color: 'text-blue-400'
    },
    {
      ...
      icon: Truck,
      href: '/dashboard/stockly/reports/supplier-spend',
    ...
    },
    {
      ...
      icon: AlertTriangle,
      href: '/dashboard/stockly/reports/variance',
    ...
    },
    {
      ...
      icon: TrendingUp,
      href: '/dashboard/stockly/reports/prices',
    ...
    },
    {
      ...
      icon: BarChart3,
      href: '/dashboard/stockly/reports/dead-stock',
