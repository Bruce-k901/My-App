              ...
              return (
                <div key={month.month} className="flex-1 flex flex-col items-center gap-2">
                  <div className="w-full flex flex-col items-center justify-end h-32">
                    ...
                    <div 
                      className="w-full bg-gradient-to-t from-[#D37E91]/80 to-[#D37E91]/60 rounded-t-md transition-all duration-500"
            ...
            <table className="w-full">
              <thead>
                <tr className="border-b border-white/[0.06]">
                  ...
                  <th className="px-4 py-3 text-right text-sm font-medium text-white/60">Deliveries</th>
                  <th className="px-4 py-3 text-right text-sm font-medium text-white/60">Net</th>
                  <th className="px-4 py-3 text-right text-sm font-medium text-white/60">VAT</th>
                  <th className="px-4 py-3 text-right text-sm font-medium text-white/60">Gross</th>
                  <th className="px-4 py-3 text-right text-sm font-medium text-white/60">Avg/Delivery</th>
              ...
              <tfoot>
                <tr className="bg-white/[0.03]">
                  ...
                  <td className="px-4 py-3 text-right font-semibold text-white">{totalDeliveries}</td>
                  <td className="px-4 py-3 text-right font-semibold text-white">
                    {formatCurrency(supplierData.reduce((sum, s) => sum + s.subtotal, 0))}
                  </td>
                  <td className="px-4 py-3 text-right font-semibold text-white/60">
