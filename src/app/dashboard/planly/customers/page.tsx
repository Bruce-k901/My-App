...
export default function CustomersPage() {
  ...
  useEffect(() => {
    ...
    if (editId) {
      ...
      if (customerToEdit) {
        ...
        // Clean up URL
        window.history.replaceState({}, '', '/dashboard/planly/customers');
      }
    }
  ...
  const handleViewCustomer = (customer: Customer) => {
    router.push(`/dashboard/planly/customers/${customer.id}`);
  };
    ...
    return (
      <div className="flex items-center justify-center min-h-[400px]">
        <div className="text-center">
          <div className="w-8 h-8 border-4 border-[#14B8A6] border-t-transparent rounded-full animate-spin mx-auto mb-4"></div>
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          ...
          <div className="flex gap-3">
            <Button
              ...
              className="bg-transparent text-[#14B8A6] border-[#14B8A6] hover:shadow-[0_0_12px_rgba(20,184,166,0.7)]"
            >
            ...
            <Button
              ...
              className="bg-transparent text-[#14B8A6] border border-[#14B8A6] hover:shadow-[0_0_12px_rgba(20,184,166,0.7)]"
            >
