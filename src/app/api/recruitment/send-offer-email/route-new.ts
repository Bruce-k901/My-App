    ...
    <div style="padding: 36px 32px;">
      ...
      <div style="margin-bottom: 28px;">
        ...
        <p style="margin: 0; color: rgba(255, 255, 255, 0.85); font-size: 16px; line-height: 1.6;">
          We're delighted to offer you the position of <span style="color: #8A2B2B; font-weight: 600;">${jobTitle}</span>.
        </p>
      </div>
      ...
      <div style="margin: 40px 0 32px;">
        <div style="text-align: center; margin-bottom: 20px;">
          <p style="margin: 0; color: rgba(255, 255, 255, 0.5); font-size: 13px; text-transform: uppercase; letter-spacing: 1px; font-weight: 600;">
            Your Response
          </p>
        </div>
        ...
        <table cellpadding="0" cellspacing="0" style="width: 100%; margin: 0;">
          <tr>
            <td style="padding: 0 0 12px 0;">
              <a href="${process.env.NEXT_PUBLIC_APP_URL || 'http://localhost:3000'}/confirm/${confirmationToken}" 
                 style="display: block; background: linear-gradient(135deg, #10B981 0%, #059669 100%); color: #ffffff; text-decoration: none; padding: 20px; border-radius: 12px; font-weight: 700; font-size: 16px; text-align: center; letter-spacing: 0.3px; box-shadow: 0 4px 20px rgba(16, 185, 129, 0.25); border: 1px solid rgba(16, 185, 129, 0.3);">
          ...
          <tr>
            <td style="padding: 0 0 12px 0;">
              <a href="${process.env.NEXT_PUBLIC_APP_URL || 'http://localhost:3000'}/confirm/${confirmationToken}" 
                 style="display: block; background: rgba(255, 255, 255, 0.03); color: rgba(255, 255, 255, 0.9); text-decoration: none; padding: 18px; border-radius: 12px; font-weight: 700; font-size: 15px; text-align: center; letter-spacing: 0.3px; border: 1px solid rgba(255, 255, 255, 0.1);">
          ...
          <tr>
            <td style="padding: 0;">
              <a href="${process.env.NEXT_PUBLIC_APP_URL || 'http://localhost:3000'}/confirm/${confirmationToken}" 
                 style="display: block; background: rgba(239, 68, 68, 0.1); color: rgba(255, 255, 255, 0.7); text-decoration: none; padding: 14px; border-radius: 12px; font-weight: 600; font-size: 13px; text-align: center; letter-spacing: 0.3px; border: 1px solid rgba(239, 68, 68, 0.2);">
                Decline Offer
              </a>
            </td>
          </tr>
        ...
        <!-- Link Alternative -->
        <div style="text-align: center; margin-top: 20px; padding: 16px; background: rgba(138, 43, 43, 0.05); border-radius: 8px;">
          <p style="margin: 0 0 8px; color: rgba(255, 255, 255, 0.4); font-size: 11px; text-transform: uppercase; letter-spacing: 0.8px;">
            Confirmation Link
          </p>
          <a href="${process.env.NEXT_PUBLIC_APP_URL || 'http://localhost:3000'}/confirm/${confirmationToken}" 
             style="color: #8A2B2B; text-decoration: none; font-size: 12px; font-weight: 600; word-break: break-all;">
