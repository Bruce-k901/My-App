...
export async function POST(req: Request) {
  try {
    ...
    const htmlBody =
      ...
      `<div style="background: linear-gradient(135deg, #8A2B2B 0%, #8B5CF6 100%); padding: 32px; text-align: center;">` +
      ...
      `<p style="margin: 0; color: rgba(255,255,255,0.6); font-size: 13px;">To accept a shift, open the app and go to <strong style="color:#8A2B2B;">Notifications</strong>.</p>` +
      `</div></div>`;
