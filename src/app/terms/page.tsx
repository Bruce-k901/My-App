    ...
    <MarketingSubPageLayout>
      <section className="max-w-3xl mx-auto text-left py-16 px-6 space-y-6">
        ...
        <div>
          ...
          <p className="text-theme-tertiary">You’re responsible for:</p>
        ...
        <div>
          ...
          <p className="text-theme-tertiary mb-3">
            <strong className="text-theme-primary">60-Day Free Trial:</strong> New accounts receive a 60-day free trial period. 
            No payment information is required during the trial. You can use all features of your selected plan during this period.
          </p>
          <p className="text-theme-tertiary mb-3">
            <strong className="text-theme-primary">Monthly Billing:</strong> After your trial ends, you will be invoiced monthly 
            via email. We use manual invoicing - no automatic payments are set up. Invoices are due within 30 days of issue.
          </p>
          <p className="text-theme-tertiary mb-3">
            <strong className="text-theme-primary">Cancellation:</strong> To cancel your subscription, you must provide 60 days 
        ...
        <div>
          ...
          <p className="text-theme-tertiary">You agree not to:</p>
          <ul className="list-disc pl-6 space-y-2 text-theme-tertiary">
        ...
        <div>
          ...
          <p className="text-theme-tertiary mb-3">
            <strong className="text-theme-primary">Cancellation by You:</strong> You can cancel your subscription by providing
