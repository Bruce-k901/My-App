    ...
    <div className="min-h-screen flex flex-col bg-neutral-950 text-theme-primary">
      ...
      <main className="flex-1">
        ...
        <section className="flex flex-col items-center justify-center text-center px-6 py-12">
          <h1 className="text-5xl md:text-6xl font-bold mb-6 bg-gradient-to-r from-magenta-500 to-blue-500 bg-clip-text text-transparent drop-shadow-[0_0_12px_rgba(138, 43, 43,0.4)]">
